...
/* package edmonds-1.0.3.3 */
#define VERSION_edmonds "1.0.3.3"
#define MIN_VERSION_edmonds(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "edmonds-1.0.3.3"

#define CURRENT_PACKAGE_KEY "edmonds-1.0.3.3"
